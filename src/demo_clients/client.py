...
parser = argparse.ArgumentParser(description="Call proxy")
parser.add_argument("--c", default=1, type=int, choices=[1, 2, 3, 4, 5, 6], required=True, help="The action to call")
